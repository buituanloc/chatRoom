        ...
        $.ajax({
            ...
            success: function (response){
                ...
                const infoNameHTML = `<div class="flex flex-wrap items-center" id="Room-${info_room.id}">
                                        <div class="h-12 w-12">
                                            <img src="${info_room.icon ?? 'http://chatroom.th/images/avatar.jpg'}" alt="avatar" class="w-full h-full rounded-full border-2 border-red-500" />
                                        </div>
                    ...
                    listMemHTML += `<div class="col-span-1 mb-5 w-full">
                                        <div class="h-[65px] bg-white flex rounded-lg">
                                            <div class="h-full p-2">
                                                <img src="${list_members[i].icon ?? 'http://chatroom.th/images/avatar.jpg'}" alt="avatar" class="w-full h-full rounded-full border-2 border-red-500" />
                                            </div>
