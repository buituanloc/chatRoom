        ...
        <div class="w-full py-8 px-4">
            <div class="flex justify-start items-center gap-4">
                <div class="w-12 h-12 rounded-full">
                    @include('components.avatar', ['avatar_path' => 'http://chatroom.th/images/avatar.jpg'])
                </div>
            ...
            <div class="col-span-1 w-full h-full bg-[#212540] px-4" id="column_detail_room">
                <div id="InfoRoom" class="">
                    ...
                    <form id="searchMember">
                        <div class="relative">
                            <label>
                                <input type="text" class="w-full h-[40px] rounded-[5px] p-2" id="inputNameMember">
...
@include('components.modals.boxChat' )
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if(response.icon === null){
                        response.icon = 'http://chatroom.th/images/avatar.jpg';
                    }
